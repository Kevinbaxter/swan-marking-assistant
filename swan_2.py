...
def run_swan_analysis(file, ext):
    ...
    strengths, weaknesses, actions, next_steps = [], [], [], []
    text = " ".join(paragraphs).lower()
    ...
    # LINKING WORDS
    LINKERS = ["however", "therefore", "in addition", "furthermore", "moreover",
    ...
    # NEXT STEPS
    next_steps.extend([
        "Read your work aloud to check that it flows logically.",
        "Compare your structure to a model answer to see how you could improve organisation.",
        "Ask a peer or teacher to highlight one unclear section, then rewrite it."
    ])
